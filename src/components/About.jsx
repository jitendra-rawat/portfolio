...
const About = () => {
  return (
    <div id='about' className="container mx-auto max-w-7xl py-28">
      ...
      <div className="mt-20 flex gap-8 items-start justify-between">

        {/* Left Section */}
        <div className="w-1/3 ">
          <img src={image} alt="Profile" className=" w-[400px] h-[500px] object-cover rounded-lg mx-auto" />
        </div>
        ...
        <div className="w-2/3  ">
          ...
          {/* First Box */}
          <div className="bg-gray-100 rounded-2xl px-4 py-8 w-[400px] h-[300px] mb-2 flex items-center">

            <div className='flex flex-col justify-center mx-auto container'>

          

            <FaLaptop className=" mx-auto" size={30} />
            <div className='flex flex-col mx-auto'>
              <h3 className="text-lg font-semibold font-poppins text-center">Experience</h3>
              <p className="text-gray-500 font-poppins text-center">2.5 + years</p>
              <p className="text-gray-700 font-poppins text-center">Software Development</p>
            </div>
...
<FaBook className=" mx-auto" size={30} />
<div className='flex flex-col mx-auto'>
  <h3 className="text-lg font-semibold font-poppins text-center">Education</h3>
  <p className="text-gray-500 font-poppins text-center">Btech in Computer Engineering</p>
  <p className="text-gray-700 font-poppins text-center">Diploma in Computer Science & Engineering</p>
</div>
          ...
          {/* Paragraph */}
          <p className="text-gray-700 font-poppins py-2 px-4">
